...
txtNumber = input ('Enter number')

number = int (txtNumber)
summ = 0
...
print((f'sum of the numbers {txtNumber} equals {summ} ' '('), * [ i for i in txtNumber], sep="+", end=")" )

#print (* [i for i in txtNumber])